...
const ReviewList: React.FC = () => {
  ...
  return (
    <div data-testid="wh-review-list">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-h2 font-heading text-text-primary">Listing Review</h1>
          <p className="text-body text-text-muted mt-1">WH-P0-06 · warehouse FIFO queue · no reject listing</p>
        </div>
          ...
          <DataTable
            ...
            columns={[
              ...
              },
              {
                ...
                header: '',
                render: (r) => (
                  <Button size="sm" variant="primary" onClick={(e: React.MouseEvent) => { e.stopPropagation(); navigate(`/wh/review/${r.device.imei}`); }}>
                    Start Review
                  </Button>
                ),
              },
