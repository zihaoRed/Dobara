...
const CONFIG_ITEMS: ConfigItem[] = [
  ...
  { key: 'pricing.bdy.b4_loose', label: 'B4 Button looseness — Loose (INR)', type: 'number', default: 400, group: 'A' },
  { key: 'pricing.bdy.b4_stuck_broken', label: 'B4 Button looseness — Stuck/Broken (INR)', type: 'number', default: 1000, group: 'A' },
