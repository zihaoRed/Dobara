...
const CONFIG_ITEMS: ConfigItem[] = [
  ...
  // Screen cosmetic (A4)
  // Appearance point-check tiers (one param per deduction code, PRD 06 §3.3.2.1.4)
  { key: 'pricing.dsp.d1_slight', label: 'D1 Burn-in / Aging — Slight (INR)', type: 'number', default: 500, group: 'A' },
  { key: 'pricing.dsp.d1_obvious', label: 'D1 Burn-in / Aging — Obvious (INR)', type: 'number', default: 1500, group: 'A' },
  { key: 'pricing.dsp.d2_1_2_dots', label: 'D2 Dead / Bright pixels — 1–2 dots (INR)', type: 'number', default: 300, group: 'A' },
  { key: 'pricing.dsp.d2_3_or_lines', label: 'D2 Dead / Bright pixels — ≥3 or lines (INR)', type: 'number', default: 1200, group: 'A' },
  { key: 'pricing.dsp.d3_slight', label: 'D3 Color cast — Slight (INR)', type: 'number', default: 400, group: 'A' },
  { key: 'pricing.dsp.d3_obvious', label: 'D3 Color cast — Obvious (INR)', type: 'number', default: 1000, group: 'A' },
  { key: 'pricing.dsp.d4_occasional', label: 'D4 Flicker — Occasional (INR)', type: 'number', default: 800, group: 'A' },
  { key: 'pricing.dsp.d4_persistent', label: 'D4 Flicker — Persistent (INR)', type: 'number', default: 2000, group: 'A' },
  { key: 'pricing.dsp.d5_edge_bleed', label: 'D5 Bleed / Leak — Edge bleed (INR)', type: 'number', default: 600, group: 'A' },
  { key: 'pricing.dsp.d5_liquid_leak', label: 'D5 Bleed / Leak — Liquid leak (INR)', type: 'number', default: 2500, group: 'A' },
  { key: 'pricing.dsp.d6_partial', label: 'D6 Touch response — Partial (INR)', type: 'number', default: 1000, group: 'A' },
  { key: 'pricing.dsp.d6_major_fail', label: 'D6 Touch response — Major fail (INR)', type: 'number', default: 0, group: 'A' },
  { key: 'pricing.gls.g1_hairline', label: 'G1 Scratch depth — Hairline (INR)', type: 'number', default: 200, group: 'A' },
  { key: 'pricing.gls.g1_shallow', label: 'G1 Scratch depth — Shallow (INR)', type: 'number', default: 800, group: 'A' },
  { key: 'pricing.gls.g1_deep', label: 'G1 Scratch depth — Deep (INR)', type: 'number', default: 2000, group: 'A' },
  { key: 'pricing.gls.g2_few_1_5', label: 'G2 Scratch count — Few (1–5) (INR)', type: 'number', default: 300, group: 'A' },
  { key: 'pricing.gls.g2_many_6_15', label: 'G2 Scratch count — Many (6–15) (INR)', type: 'number', default: 900, group: 'A' },
  { key: 'pricing.gls.g2_dense', label: 'G2 Scratch count — Dense (INR)', type: 'number', default: 1800, group: 'A' },
  { key: 'pricing.gls.g3_edge', label: 'G3 Glass crack — Edge (INR)', type: 'number', default: 1500, group: 'A' },
  { key: 'pricing.gls.g3_display_area', label: 'G3 Glass crack — Display area (INR)', type: 'number', default: 3000, group: 'A' },
  { key: 'pricing.gls.g3_shattered', label: 'G3 Glass crack — Shattered (INR)', type: 'number', default: 0, group: 'A' },
  { key: 'pricing.gls.g4_slight', label: 'G4 Delamination — Slight (INR)', type: 'number', default: 800, group: 'A' },
  { key: 'pricing.gls.g4_obvious', label: 'G4 Delamination — Obvious (INR)', type: 'number', default: 0, group: 'A' },
  { key: 'pricing.bdy.b1_slight', label: 'B1 Paint / Oxidation — Slight (INR)', type: 'number', default: 300, group: 'A' },
  { key: 'pricing.bdy.b1_obvious', label: 'B1 Paint / Oxidation — Obvious (INR)', type: 'number', default: 900, group: 'A' },
  { key: 'pricing.bdy.b2_slight', label: 'B2 Dents — Slight (INR)', type: 'number', default: 400, group: 'A' },
  { key: 'pricing.bdy.b2_obvious', label: 'B2 Dents — Obvious (INR)', type: 'number', default: 1200, group: 'A' },
  { key: 'pricing.bdy.b3_slight', label: 'B3 Frame bend — Slight (INR)', type: 'number', default: 800, group: 'A' },
  { key: 'pricing.bdy.b3_obvious', label: 'B3 Frame bend — Obvious (INR)', type: 'number', default: 2000, group: 'A' },
  { key: 'pricing.bdy.b7_slight', label: 'B7 Frame scratches — Slight (INR)', type: 'number', default: 300, group: 'A' },
  { key: 'pricing.bdy.b7_obvious', label: 'B7 Frame scratches — Obvious (INR)', type: 'number', default: 900, group: 'A' },
  { key: 'pricing.bdy.b5_worn', label: 'B5 Antenna strip — Worn (INR)', type: 'number', default: 300, group: 'A' },
  { key: 'pricing.bdy.b5_broken', label: 'B5 Antenna strip — Broken (INR)', type: 'number', default: 800, group: 'A' },
  { key: 'pricing.bdy.b6_screw_marks', label: 'B6 Repair traces — Screw marks (INR)', type: 'number', default: 500, group: 'A' },
  { key: 'pricing.bdy.b6_missing_screws', label: 'B6 Repair traces — Missing screws (INR)', type: 'number', default: 1200, group: 'A' },
  { key: 'pricing.bck.rc1_slight', label: 'RC1 Back scratches — Slight (INR)', type: 'number', default: 300, group: 'A' },
  { key: 'pricing.bck.rc1_obvious', label: 'RC1 Back scratches — Obvious (INR)', type: 'number', default: 900, group: 'A' },
  { key: 'pricing.bck.rc2_partial', label: 'RC2 Back crack — Partial (INR)', type: 'number', default: 1500, group: 'A' },
  { key: 'pricing.bck.rc2_large_area', label: 'RC2 Back crack — Large area (INR)', type: 'number', default: 3000, group: 'A' },
  { key: 'pricing.bck.rc3_slight', label: 'RC3 Back wear — Slight (INR)', type: 'number', default: 200, group: 'A' },
  { key: 'pricing.bck.rc3_severe', label: 'RC3 Back wear — Severe (INR)', type: 'number', default: 800, group: 'A' },
  { key: 'pricing.bck.rc4_slight', label: 'RC4 Battery swell — Slight (INR)', type: 'number', default: 1500, group: 'A' },
  { key: 'pricing.bck.rc4_obvious', label: 'RC4 Battery swell — Obvious (INR)', type: 'number', default: 0, group: 'A' },
  { key: 'pricing.bck.rc5_slight', label: 'RC5 Camera lens — Slight (INR)', type: 'number', default: 400, group: 'A' },
  { key: 'pricing.bck.rc5_affects_imaging', label: 'RC5 Camera lens — Affects imaging (INR)', type: 'number', default: 1500, group: 'A' },
  { key: 'pricing.prt.p1_loose', label: 'P1 Charging port — Loose (INR)', type: 'number', default: 500, group: 'A' },
  { key: 'pricing.prt.p1_damaged', label: 'P1 Charging port — Damaged (INR)', type: 'number', default: 1500, group: 'A' },
  { key: 'pricing.prt.p2_slight', label: 'P2 Port corrosion — Slight (INR)', type: 'number', default: 600, group: 'A' },
  { key: 'pricing.prt.p2_obvious', label: 'P2 Port corrosion — Obvious (INR)', type: 'number', default: 2000, group: 'A' },
  { key: 'pricing.prt.p3_soft', label: 'P3 Volume keys — Soft (INR)', type: 'number', default: 300, group: 'A' },
  { key: 'pricing.prt.p3_failed', label: 'P3 Volume keys — Failed (INR)', type: 'number', default: 800, group: 'A' },
  { key: 'pricing.prt.p4_soft', label: 'P4 Power key — Soft (INR)', type: 'number', default: 300, group: 'A' },
  { key: 'pricing.prt.p4_failed', label: 'P4 Power key — Failed (INR)', type: 'number', default: 800, group: 'A' },
  { key: 'pricing.prt.p5_dusty', label: 'P5 Speaker / Jack — Dusty (INR)', type: 'number', default: 200, group: 'A' },
  { key: 'pricing.prt.p5_damaged', label: 'P5 Speaker / Jack — Damaged (INR)', type: 'number', default: 600, group: 'A' },
  { key: 'pricing.prt.p6_soft', label: 'P6 Other buttons (mute/Action) — Soft (INR)', type: 'number', default: 300, group: 'A' },
  { key: 'pricing.prt.p6_failed', label: 'P6 Other buttons (mute/Action) — Failed/Stuck (INR)', type: 'number', default: 800, group: 'A' },
...
const MAPPING_ROWS: MappingRow[] = [
  ...
  { group: 'Body', option: 'Minor scratches', code: 'CO-BDY-13', key: 'mapping.body.minor', default: 300 },
  { group: 'Body', option: 'Visible dents & scratches', code: 'CO-BDY-04/14 (conservative)', key: 'mapping.body.visible', default: 1200 },
  { group: 'Body', option: 'Deformed / back cracked', code: 'CO-BDY-06/CO-BCK-04 (conservative)', key: 'mapping.body.severe', default: 3000 },
  // Screen cosmetic
  { group: 'Screen', option: 'Like new', code: '— (no deduction)', key: 'mapping.screen.like_new', default: 0 },
  { group: 'Screen', option: 'Minor scratches', code: 'CO-GLS-01', key: 'mapping.screen.minor', default: 200 },
  { group: 'Screen', option: 'Visible scratches', code: 'CO-GLS-03', key: 'mapping.screen.visible', default: 2000 },
  { group: 'Screen', option: 'Cracked', code: 'CO-GLS-08', key: 'mapping.screen.cracked', default: 3000 },
  // Screen display
  { group: 'Display', option: 'Perfect', code: '— (no deduction)', key: 'mapping.display.perfect', default: 0 },
  { group: 'Display', option: 'Minor burn-in / bright spots', code: 'CO-DSP-01', key: 'mapping.display.burn_in', default: 500 },
  { group: 'Display', option: 'Dead pixels / color lines', code: 'CO-DSP-04', key: 'mapping.display.dead_pixel', default: 1200 },
  { group: 'Display', option: 'Not displaying', code: 'CO-DSP-08', key: 'mapping.display.not_displaying', default: 2500 },
  // Repair history
  ...
  { group: 'Functional', option: 'Buttons not working', code: 'CO-PRT-06/08 (conservative)', key: 'mapping.functional.buttons', default: 800 },
