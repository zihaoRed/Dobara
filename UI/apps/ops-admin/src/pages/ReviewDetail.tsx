...
const ReviewDetail: React.FC = () => {
  ...
  return (
    <div data-testid="ops-review-detail">
      <div className="flex items-center justify-between mb-6 gap-4 flex-wrap">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="sm" icon={<ArrowLeft size={18} />} onClick={() => navigate('/review')} />
          <div>
        ...
        <div className="w-full xl:w-[380px] flex-shrink-0 space-y-4">
          ...
          <Card variant="default">
            ...
            <CardContent>
              ...
              <p className="text-caption text-text-muted mb-2">Ops cannot edit grade manually.</p>
